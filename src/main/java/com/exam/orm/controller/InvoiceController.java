...
public class InvoiceController {
    ...
    ResponseEntity<Invoice> addInvoice(@RequestBody Invoice invoice) {
        return new ResponseEntity<Invoice>(invoiceService.saveInvoice(invoice), HttpStatus.BAD_REQUEST);
    ...
    @RequestMapping(method = RequestMethod.DELETE, value = "/app/invoice/{invoiceId}", consumes = "application/json")
    ...
    @RequestMapping(method = RequestMethod.DELETE, value = "/app/invoice", consumes = "application/json")
    ...
    @RequestMapping(method = RequestMethod.GET, value = "/app/invoice/{contactId}", consumes = "application/json")
    ...
    @RequestMapping(method = RequestMethod.GET, value = "/app/invoice", consumes = "application/json")
